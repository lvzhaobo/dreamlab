...
<html>
  <head>
    ...
    <style type="text/css">
	  ...
	  .project_item {width:100%;height:140px;margin:10px;float:left;color:#333333;border:1px solid #F3F3F3;box-shadow:0 1px 5px #999999;background-color:#FFFFFF;}
	  .project_item:hover {border:1px solid #0088FF;background-color:#FFFFFF;#color:#FF6600;box-shadow:0 0px 2px #0088FF;}
		  ...
		  <!--<div style="margin:0 0 0 0px;height:48px;border-bottom:2px solid #F3F3F3;">
			  ...
			  <?php 
			      $data = array(
								...
								array("name"=>"阿里云SLB","url"=>$workspace."course/aliyun-slb-essential.php","img"=>$workspace."src/images/dream.jpg","text"=>"初步了解阿里云SLB，服务器负载均衡包括SLB购买、查看状态、登录后台、在应用中使用等。","type"=>"入门级","started"=>true,"required"=>"无前提课程"),
